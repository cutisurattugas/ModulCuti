...
class Cuti extends Model
{
    ...
    protected $fillable = ['tanggal_mulai', 'tanggal_selesai', 'keterangan', 'dok_pendukung', 'status', 'dok_cuti', 'pegawai_id', 'pejabat_id', 'tim_kerja_id','unit_id', 'jenis_cuti_id', 'user_id'];
